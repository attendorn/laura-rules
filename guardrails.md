...
- **ANLEITUNG — modus-abhängig:** Lief die Session im **Bau-Modus** (`/laura-work`) →
  `"$LAURA_HAUPTBAUM"/ANLEITUNG-kern.md`. Im **Voll-Modus** (`/laura`) → `"$LAURA_HAUPTBAUM"/ANLEITUNG.md`.
  Im Zweifel `-kern` (der pre-compact-Hook empfiehlt den richtigen Pfad in der Summary).
